...
namespace Wangjian\Push\Sdk\Getui\Protobuf;
...
use Wangjian\Push\Sdk\Getui\Protobuf\Encoding\PBBase128;
use Wangjian\Push\Sdk\Getui\Protobuf\Type\PBScalar;
use Wangjian\Push\Sdk\Getui\Protobuf\Type\PBEnum;
use Wangjian\Push\Sdk\Getui\Protobuf\Type\PBBytes;
use Wangjian\Push\Sdk\Getui\Protobuf\Type\PBString;
use Wangjian\Push\Sdk\Getui\Protobuf\Type\PBInt;
use Wangjian\Push\Sdk\Getui\Protobuf\Reader\PBInputReader;
use Wangjian\Push\Sdk\Getui\Protobuf\Reader\PBInputStringReader;
...
abstract class PBMessage
{
    ...
    {
        $namespace_array = [
            "Wangjian\\Push\\Sdk\Getui\\Protobuf\\Type\\",
            "Wangjian\\Push\\Sdk\Getui\\IGetui\\Req\\",
        ];
